...
public class SetsAndRepsDialog extends AppCompatDialogFragment {
    private EditText editTextSets;
    private EditText editTextReps;
    private SetAndRepsDialogListener listener;

    @Override
    public void onAttach(Context context) {
        try {
            listener=(SetAndRepsDialogListener)context;
    ...
    public interface SetAndRepsDialogListener{
