 ...
 */
public class MymyworkoutsRecyclerViewAdapter extends RecyclerView.Adapter<MymyworkoutsRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MymyworkoutsRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
